...
public class ProductManager {
    ...
    @Autowired
    private ProductYeuThichService _productYeuThichService;
...
>>>>>>> eaa1fcac869126f6f18cbc26b0f5fa9ac7f54847
    ...
    public ResponseEntity<List<ProductWithImageDTO>> getListSanPhamYeuThichByIdUser(@RequestParam("userId") String userId) {
        List<ProductWithImageDTO> tmp = _productYeuThichService.getAllSpYeuThichByUserId(userId);
        for (ProductWithImageDTO i : tmp) {
